  ...
  <div id="app">
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="addDiaVisble = true">添加用户</el-button>
        </el-col>
      </el-row>
      <!-- 用户列表区域 -->
        ...
        <el-table-column label="操作" width="180">
          <template slot-scope="scope">
            ...
            <el-tooltip content="分配角色" placement="top" :enterable="false">
              <el-button type="warning" size="mini" icon="el-icon-setting" @click="showSetRole(scope.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
    ...
    <!-- 添加用户对话框 -->
    <el-dialog title="添加用户" :visible.sync="addDiaVisble" width="50%" @close="addDialogClosed">
      <!-- 内容主体区 -->
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="addDiaVisble = false">取 消</el-button>
    ...
    <el-dialog title="修改用户" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
      <el-form :model="editForm" :rules="editFormRelus" ref="editFormRef" label-width="70px">
  ...
  methods: {
    ...
    // 根据id删除用户
     async removeUserById(id){
         const confirmIfo = await this.$confirm('此操作将永久删除该用户, 是否继续?', '提示', {
